...

{
  ...
  "category_signals": string[], // place/activity categories implied, e.g. ["coffee shop", "bookstore", "park"]. Preserve specific cuisine/food types as the category — "ramen" stays "ramen", "tacos" stays "tacos", never generalized to "restaurant"
